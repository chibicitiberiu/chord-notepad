...
.. note::
   Capo handling moved out of Settings: a capo is now a ``{capo: N}`` directive
   in the song, and :menuselection:`Tools --> Suggest Capo...` finds and inserts
   a good one. See :doc:`chord_sheet` and :doc:`directives`.
